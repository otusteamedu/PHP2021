...
CREATE TABLE public.halls (
                              ...
                              num_section smallint DEFAULT 0 NOT NULL,
                              price_ratio numeric(2,1) DEFAULT NULL::numeric NOT NULL
);
...
-- Name: prices prices_row_min_row_max_time_hall_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.prices
    ADD CONSTRAINT prices_row_min_row_max_time_hall_id_key UNIQUE (row_min, row_max, "time", hall_id);
