<svg class="icon green_icon" viewBox="0 0 111 134" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php foreach ($GLOBALS['HEROES'] as $hero) { ?>
    <form class="update-form" action="../../request.php" method="post">
