<div class="wrapper">
    <svg class="icon green_icon" viewBox="0 0 154 154" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <table>
        ...
        <tr>
            <td><?php echo $GLOBALS['SEARCHED_HERO']->getId() ?></td>
            <td><?php echo $GLOBALS['SEARCHED_HERO']->getNickname() ?></td>
            <td><?php echo $GLOBALS['SEARCHED_HERO']->getRealName() ?></td>
            <td><?php echo $GLOBALS['SEARCHED_HERO']->getForce() ?></td>
        </tr>
    </table>
