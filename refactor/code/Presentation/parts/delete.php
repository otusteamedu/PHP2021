<svg class="icon green_icon" viewBox="0 0 126 141" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php foreach ($GLOBALS['HEROES'] as $hero) { ?>
    <div class="delete">
        ...
        <a href="/request.php?action=delete&id=<?php echo $hero->getId() ?>" class="delete__link">
